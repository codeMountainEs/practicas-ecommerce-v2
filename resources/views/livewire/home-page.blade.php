<div>
    @livewire('inicio.imagenes', ['categories' =>$categories])
                ...
                <div class="p-4 md:p-5">
                    <div class="flex justify-between items-center">
                        <div class="flex items-center">
                            <img class="h-[2.375rem] w-[2.375rem] rounded-full" src="{{ asset('storage/'. $category->image) }}" alt="{{ $category->name }}"  alt="Image Description">
                            <div class="ms-3">
